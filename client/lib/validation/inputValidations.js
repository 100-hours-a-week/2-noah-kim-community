 ...
 */
const validateEmailInput = (targetValue, errorTextElement) => {
 ...
 * @returns 유효성 검사 여부 (Boolean)
 */
const validatePasswordInput = (passwordValue, errorTextElement) => {
 ...
 * @returns 유효성 검사 여부 (Boolean)
 */
const validatePasswordConfirmInput = (passwordValue, passwordConfirmValue, errorTextElement) => {
  // 유효성 검사
  let isValid = true
  let errorText = ''
