...
class Register extends Component {
  ...
  mounted() {
    ...
    this.$elements = {
      ...
      passwordConfirmErrorText: this.$target.querySelector(
  ...
  setEvent() {
    // 입력 이벤트
    this.addEvent("input", "#email-val", (event) => {
      this.validateEmail();
      this.updateButtonState();
    });
    this.addEvent("input", "#password-val", (event) => {
      this.validatePassword();
      this.updateButtonState();
    });
    this.addEvent("input", "#password-confirm-val", (event) => {
      this.validatePasswordConfirm();
      this.updateButtonState();
    });
    this.addEvent("input", "#nickname-val", (event) => {
      this.validateNickname();
      this.updateButtonState();
    });
    this.addEvent("change", "#profile-val", (event) => {
      this.validateProfile();
      this.updateButtonState();
    });
    this.addEvent("click", "#profile-preview", this.getProfileImage.bind(this));
    this.addEvent(
      "change",
      "#profile-val",
      this.onProfileChangeHandler.bind(this)
    );

    // 클릭 이벤트
    this.addEvent("click", "#back-button", this.backRouteHandler.bind(this));
    this.addEvent("click", "#login-button", this.loginRouteHandler.bind(this));
    this.addEvent(
      "click",
      "#register-button",
